...
namespace AUF.EMR2.Persistence.Migrations
{
    ...
    [Migration("20250103095112_AddHouseholdMember")]
    partial class AddHouseholdMember
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AUF.EMR2.Domain.Aggregates.BarangayAggregate.Barangay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ce2cc1cf-835b-4ea9-a8b8-210d73e82128"),
                            BarangayHealthStation = "Barangay Health Station",
                            BarangayName = "Brgy. Ninoy Aquino",
                            ContactNo = "09XXXXXXXXX",
                            DateCreated = new DateTime(2025, 1, 3, 17, 51, 9, 733, DateTimeKind.Local).AddTicks(4952),
                            LastModified = new DateTime(2025, 1, 3, 17, 51, 9, 733, DateTimeKind.Local).AddTicks(4963),
                            RuralHealthUnit = "Rural Health Unit",
                            Status = true,
                            Version = new Guid("2f3ed443-f9e4-49fd-a2e7-91a685f1709c")
                        });
                });
