        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseholdId1 = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HouseholdMembers_Households_HouseholdId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseholdMemberId1 = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PregnancyTrackings_HouseholdMembers_HouseholdMemberId1",
                        column: x => x.HouseholdMemberId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId1 = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VaccinationRecords_HouseholdMembers_PatientId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WomenOfReproductiveAge_HouseholdMembers_HouseholdMemberId1",
                        column: x => x.HouseholdMemberId1,
                        principalTable: "HouseholdMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("484d39ef-1a24-4b4a-941f-05700f27484e"), "Barangay Health Station", "Brgy. Ninoy Aquino", "09123441233", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "Angeles City", "Pampanga", "III", "Rural Health Unit", true, "Ninoy Aquino", new Guid("00000000-0000-0000-0000-000000000000") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseholdMembers_HouseholdId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PregnancyTrackings_HouseholdMemberId1",
                table: "PregnancyTrackings",
                column: "HouseholdMemberId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccinationRecords_PatientId1",
                table: "VaccinationRecords",
                column: "PatientId1");

            migrationBuilder.CreateIndex(
                name: "IX_WomenOfReproductiveAge_HouseholdMemberId1",
