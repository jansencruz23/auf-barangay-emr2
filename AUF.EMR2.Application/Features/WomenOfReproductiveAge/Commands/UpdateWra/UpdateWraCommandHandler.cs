...
{
    public class UpdateWraCommandHandler : IRequestHandler<UpdateWraCommand, BaseCommandResponse<int>>
    {
        ...
        public async Task<BaseCommandResponse<int>> Handle(UpdateWraCommand request, CancellationToken cancellationToken)
        {
